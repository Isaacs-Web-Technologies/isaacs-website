...
function Afrowithphone(props) {
  return (
    <>
    <section className="justify-center pb-2 px-20 max-md:px-5">
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
        <Column className="flex flex-col items-stretch w-[52%] max-md:w-full max-md:ml-0">
        ...
        <Column className="flex flex-col items-stretch w-[48%] ml-5 max-md:w-full max-md:ml-0">
          <Image
            loading="lazy"
