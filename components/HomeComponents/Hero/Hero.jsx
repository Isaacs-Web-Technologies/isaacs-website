...
function Hero(props) {
  return (
    <form className="justify-center items-stretch bg-neutral-100 flex flex-col">
          ...
          <div className="max-w-full justify-center relative w-[1140px] mx-auto px-3 py-6 max-md:pl-5">
            <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
              <div className="flex flex-col items-stretch w-[45%] max-md:w-full max-md:ml-0">
                ...
                <button
                  className="text-white text-center text-lg font-bold leading-4 uppercase whitespace-nowrap items-stretch self-center justify-center bg-purple-600 accent-[hex8F00FF] mr-auto my-auto px-8 py-5 rounded-3xl max-md:px-5"
