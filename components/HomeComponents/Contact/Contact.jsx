        ...
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
          <div className="flex flex-col items-stretch w-6/12 max-md:w-full max-md:ml-0">
            <Image
              ...
              className="aspect-[0.69] object-cover object-center w-full shrink-0 box-border min-h-[20px] min-w-[20px] overflow-hidden mt-5 max-sm:max-w-[330px]"
              width={200}
              height={300}
          ...
          <div className="flex flex-col items-stretch w-6/12 ml-5 max-md:w-full max-md:ml-0">
            <span className="items-center content-center flex-wrap shadow-lg bg-white bg-opacity-0 flex grow flex-col w-full pl-8 pr-12 pt-5 pb-12 max-md:max-w-full max-md:px-5 max-sm:mr-0">
              ...
              <div className="bg-violet-300 self-stretch flex w-full shrink-0 h-px flex-col mr-3 mt-10 max-md:mr-2.5" />
              <div className="bg-violet-300 self-stretch flex w-full shrink-0 h-px flex-col mr-3 mt-10 max-md:mr-2.5" />
              <button className="items-stretch shadow-sm bg-purple-600 flex w-[219px] max-w-full flex-col justify-center mt-20 px-10 py-4 rounded-3xl self-start max-md:px-5">
